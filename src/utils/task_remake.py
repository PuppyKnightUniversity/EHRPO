...
# TODO: readmission prediction
def patient_level_readmission_prediction_mimic3(patient, dataset='mimic3', time_window=15):
    samples = []
    ...
    # define label
    idx_last_visit = len(patient) - 1
    time_diff =  (patient[idx_last_visit].encounter_time - patient[idx_last_visit-1].encounter_time).days
